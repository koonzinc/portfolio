...
const Experience = () => {
  return (
    <div className='text-[#1C3879] subpixel-antialiased'>
        <div className='flex flex-col h-screen w-full max-w-[700px] mx-auto'>
        ...
        <p className='text-gray-500 mb-10'>
            ...
            <div className='flex flex-row w-full justify-center'>
                <div className='flex flex-col rounded-xl bg-white w-[200px] p-8 shadow-xl'>
                ...
                <div className='flex flex-col  rounded-xl bg-white w-[200px] mx-5  md:mx-10 p-8 shadow-xl'>
