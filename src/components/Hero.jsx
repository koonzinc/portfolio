...
const Hero = () => {
  return (
    <div className='text-[#1c3879] subpixel-antialiased'>
        <div className='max-w-[1364px] px-14 mt-[-132px] w-full h-screen flex flex-col justify-center mx-auto'>
            ...
            <h2 className='transition-text duration-700 text-[32px] sm:text-[40px] md:text-[48px] lg:text-[56px] font-bold text-secondary'>
                ...
                <Typed className='transition-text duration-700 text-[32px] sm:text-[40px] md:text-[48px] lg:text-[56px] font-bold text-secondary' strings={['HTML', 'CSS', 'JavaScript', 'React' ]} typeSpeed={120} backSpeed={140} loop />.
            </h2>
