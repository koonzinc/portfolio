...
const Nav = () => {
    ...
    return (
        <div className='flex justify-between items-center h-28 max-w-[15360px] mx-auto px-8 subpixel-antialiased'>
            ...
            <ul className={nav ? 'fixed right-0 top-0 text-center pt-10 w-[75%] h-full border-l border-l-gray-900 bg-[#FFFFFF] ease-in-out duration-500 md:hidden z-40' : 'fixed left-[-100%]'}>
